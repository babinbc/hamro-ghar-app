...
const EditOrder = () => {
    const {id} = useParams();
    const {data: orderDetails, isPending: orderDataPending, error} = useFetch('https://test-api-5zla.onrender.com/orders/' + id);
    ...
    const handleUpdate = (e) => {
        ...
        fetch('https://test-api-5zla.onrender.com/orders/' + id, {
            method: "PUT",
        ...
        .then(() => {
            setIsPending(false);
            navigate('/hamro-ghar-app/orders/' + id);
        });
    }
