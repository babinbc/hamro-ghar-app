...
const FilterOptions = ({filterValue}) => {
    ...
    const handleUnpaid = (e) => {
        if(e.target.checked){
            navigate('/hamro-ghar-app/orders/filter?unpaid=true');
            setFilter("unpaid");
        }
    }
    ...
    const handlePaid = (e) => {
        if(e.target.checked){
            navigate('/hamro-ghar-app/orders/filter?paid=true');
            setFilter("paid");
        }
    ...
    const handleFulfilled = (e) => {
        if(e.target.checked){
            navigate('/hamro-ghar-app/orders/filter?fulfilled=true&paid=true');
            setFilter("fulfilled");
        }        
    }
